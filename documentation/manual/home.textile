...
bc. #{formee.h_box for:"package.Model.field", type:'text', label_grid:3, input_grid:4, required:true /}
...
bc. #{formee.v_box for:'package.Model.field', type:'text', grid:4, required:true /}
