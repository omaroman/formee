...
<dl>
    ...
    <dt>type</dt>
    <dd>the input type, if this is not valid, then 'text' is used</dd>
    <dt>label_col (required)</dt>
    <dd>the number of columns for placing the label. _*See formee framework specification*_</dd>
    <dt>input_col (required)</dt>
    <dd>the number of columns for placing the input. _*See "formee framework":http://formee.org/ specification*_</dd>
    <dt>required (optional)</dt>
    <dd>for a visual indicator when a field is required</dd>
</dl>
...
<dl>
    ...
    <dd>the input type, if this is not valid, then 'text' is used</dd>
    <dt>col (required)</dt>
    <dd>the number of columns for placing the elements (label, input, span). _*See "formee framework":http://formee.org/ specification*_</dd>
    <dt>required (optional)</dt>
    <dd>for a visual indicator when a field is required</dd>
</dl>
