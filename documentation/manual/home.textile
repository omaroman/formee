...
The *formee.h_block* tag generates _label_, an _input_ and a _span_ (for error messages) aligned horizontally and wrapped by a _div_ element.

Params:
* <code>arg</code> (implicit optional argument) - name of the model object.
* <code>for</code> (required) - full qualified name of a field, i.e. <code>package.Model.field</code>
* <code>type</code> (optinal) - input type, if this is not provided or is not valid, then 'text' is used.
* <code>label_col</code> (required) - the number of columns for placing the label. _*See formee framework specification*_.
* <code>input_col</code> (required) - the number of columns for placing the input. _*See "formee framework":http://formee.org/ specification*_.
* <code>required</code> (optional) - boolean value to indicate, visually, if it's required.

Tag

bc. #{formee.h_block for:"package.Model.field", type:'text', label_col:3, input_col:4, required:true /}

Html

bc. <div class="field h-block grid-12-12 ">
    <div class="grid-3-12">
        <label for='model_fiel' required="true" >Field name<em class='formee-req'>*</em></label>
    </div>
    <div class="grid-4-12">
...
The *formee.v_block* tag generates _label_, an _input_ and a _span_ (for error messages) aligned vertically and wrapped by a _div_ element.

Params:
* <code>arg</code> (implicit optional argument) - name of the model object.
* <code>for</code> (required) - full qualified name of a field, i.e. <code>package.Model.field</code>
* <code>type</code> (optinal) - input type, if this is not provided or is not valid, then 'text' is used.
* <code>col</code> (required) - the number of columns for placing the label. _*See formee framework specification*_.
* <code>input_col</code> (required) - the number of columns for placing the elements (label, input, span). _*See "formee framework":http://formee.org/ specification*_.
* <code>required</code> (optional) - boolean value to indicate, visually, if it's required.
<dl>

Tag

bc. #{formee.v_block for:'package.Model.field', type:'text', col:4, required:true /}

Html

bc. <div class="field v-block grid-4-12 ">
